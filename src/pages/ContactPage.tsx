  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white p-8">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-8 border border-gray-700/50">
          {status.type && (
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                ...
                <label
                  htmlFor="attachment"
                  className="flex items-center gap-2 px-4 py-2 bg-gray-700/50 border border-gray-600 rounded-lg cursor-pointer hover:bg-gray-700/70 transition-colors"
                >
                  <PaperClipIcon className="w-5 h-5" />
                  <span>{formData.attachment ? formData.attachment.name : t('contact.form.chooseFile')}</span>
                </label>
                {formData.attachment && (
                  <button
                    type="button"
